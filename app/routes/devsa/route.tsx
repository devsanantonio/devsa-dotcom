...
export default function DevSA() {
   return (
      <>
         ...
         >
            <p>
               Our goal is to partner with existing organizations in the city,
               addressing their technology challenges. As web developers and
               software engineers, we strive to understand how we can aid in
               resolving these issues, and then collaboratively construct
               solutions that are both efficient and enduring
            </p>
         </PageIntro>
         <FadeIn>
