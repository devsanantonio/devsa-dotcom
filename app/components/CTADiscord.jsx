                        ...
                        <div className="relative mx-auto max-w-7xl py-10 sm:py-32 lg:px-8 lg:py-40">
                            <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                                ...
                                <p className="mt-2 text-3xl font-bold tracking-tight text-neutral-950 sm:text-4xl">
                                    Initiating conversations and fostering
                                    collaboration
                                </p>
                                <p className="mt-6 text-wrap text-base leading-7 text-neutral-800">
                                    Share your work, ask for help, connect with
                                    other developers in the city. Join us on
                                    Discord to stay up to date with events and
                                    meetups, and get to know the San Antonio
                                    community
                                </p>
                                <div className="mt-8">
                                    <Link
