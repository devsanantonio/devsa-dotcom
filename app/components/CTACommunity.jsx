...
export function CommunitySection() {
    return (
        <div className="mt-24 pt-24 sm:mt-32 sm:pt-32">
            ...
            >
                <p>
                    Explore a variety of virtual and in-person events taking
                    place in the city. From engaging code-alongs to delightful
                    free food events, there's an experience tailored for
                    everyone
                </p>
            </SectionIntro>
